...
**Prepared next slice, 2026-09-08:** [three planning task packs and a delivery packet](../reports/waves/lab-planning-deliverables.md)
make the PRD/HLD/LLD requirement concrete. The draft contract, fixed briefs and rubric
are prepared; real harness/mode execution, artifact-bound assessments and second-
adapter qualification are unfinished. Metadata validation is not task-quality evidence.

**Planning/design requirement, 2026-09-08:** the user explicitly expands the target
to native harness modes and PRD/HLD/LLD tasks. The [mode and assessment extension](adrl-lab-planning-and-assessment-2026-09-08.md)
separates permissions, model capabilities and deliverables; defines deterministic,
expert-assessed and delayed-utility evidence; and identifies the LRN/MEM/EVL admission
disposition needed for subjective targets. These are proposed capabilities, not
implemented task packs or approved learning data. Existing runtime/status/maturity
and real-execution gates remain unchanged.

**W7.0a execution update, 2026-09-08:** [the first routing correction](../reports/adrl-routing-correction-2026-09-08.md) is validated against preserved component and full-path lab baselines. Features-v2 fixes mixed-intent masking; conservative lexical limits remain. Next: existing W3 custody/exact-output qualification before real-task model comparisons. K0, cross-harness qualification, learned checkpoints and RSI retain their gates. Hourly continuation stays paused. Earlier dated overlays below are preserved.
