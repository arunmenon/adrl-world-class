...
| mixed-rename | local | local | local-qwen-7b | gateway_reported | responded |
| mixed-explain | local | local | local-qwen-7b | gateway_reported | responded |
...
The manifest retains every planned cell if interrupted; --inspect reports remaining work.
