...
| ADRL-CAS-009 | Action-effect provenance and authorization boundary (Proposed) | PROPOSED (new) | D0 | 2026-09-09  [Restored existing INDEX scope; offline candidate evidence](../../reports/reviews/claude-adapter-2026-09-09/report.md); no promotion. |
