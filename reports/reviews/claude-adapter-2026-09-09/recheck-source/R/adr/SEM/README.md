...
| ADRL-SEM-007 | Protocol profiles (Proposed) | PROPOSED (new) | D2 Messages boundary and local services; D0 second profile | 2026-09-09 <!-- taxonomy-sync:claude-adapter:ADRL-SEM-007 --> [Restored existing INDEX scope; offline candidate evidence](../../reports/reviews/claude-adapter-2026-09-09/report.md); no promotion. |
