...
<!-- taxonomy-sync:claude-adapter:ADRL-FND-003 --> The experiment selection occurs after permission/deployment checks and before write-ahead egress and decision recording. Decisions name experiment_forced_claude and a configuration fingerprint, distinguishing a forced compatibility choice from estimator merit. Fallback, pinned, transformed and missing-permitted-set requests cannot use the candidate. [Implementation and evidence limits](../../reports/reviews/claude-adapter-2026-09-09/report.md). Formal maturity/status/verdict are unchanged.
...
|---|---|---|
| 2026-09-09 | <!-- taxonomy-sync:claude-adapter:ADRL-FND-003 --> [Offline Claude candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); The experiment selection occurs after permission/deployment checks and before write-ahead egress and decision recording. Decisions name experiment_forced_claude and a configuration fingerprint, distinguishing a forced compatibility choice from estimator merit. Fallback, pinned, transformed and missing-permitted-set requests cannot use the candidate. | Previous decision wording and dated evidence preserved; no grade change |
