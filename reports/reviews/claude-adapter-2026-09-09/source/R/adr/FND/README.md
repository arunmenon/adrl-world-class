...
| ADRL-FND-005 | Scope expands only through measured gates | APPROVE | D3 → D3 (governance note) | Sound and currently honoured; gaps (self-graded, no pre-registration, no de-promotion) belong to EVL follow-ups  2026-09-09 <!-- taxonomy-sync:taxonomy-sync-gate:ADRL-FND-005 --> [Scoped sync gate](../../reports/reviews/taxonomy-sync-gate-2026-09-09/report.md); maturity unchanged  <!-- taxonomy-sync:claude-adapter:ADRL-FND-005 --> [2026-09-09 offline Claude candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); no maturity change |
