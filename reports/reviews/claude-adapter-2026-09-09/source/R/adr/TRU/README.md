...
| ADRL-TRU-002 | Permitted deployment set | PROPOSED (new) | none → D0 | The monotone object is a signed inventory entry (deployment id, rung, provider, api_base, trust zone, geo, data-use profile), not a rung label; dispatch yields a served-deployment receipt  <!-- taxonomy-sync:claude-adapter:ADRL-TRU-002 --> [2026-09-09 offline candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); no grade change |
