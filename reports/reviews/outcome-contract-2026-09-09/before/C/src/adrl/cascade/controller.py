"""Cascade controller: plan dispatch, observe responses, escalate at boundaries.

Primary: ADRL-CAS-003. Secondary: ADRL-CAS-001/004/005/006/007/008, ADRL-SEM-006.
    ...
    async def _plan_user_turn(
        ...
        if sticky is not None:
            events.append(
                self._event(
                    sticky.route_id,
                    OutcomeState.CLOSED_TURN.value,
                    {
