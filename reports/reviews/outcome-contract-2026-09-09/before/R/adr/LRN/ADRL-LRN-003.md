...
The runtime contains offline effect-estimator machinery, while the live Router instantiates BandHeuristicEstimator. This demonstration exercised heuristic routing and explicit rule-health demotion, not a trained live estimator or autonomous learning. The 20 invented outcome events lived in a disposable separate ledger and are not admitted data. RSI and learned-router benefit remain unproved.
