...
|---|---|---|---|---|
| ADRL-FND-001 | Transparent control layer, protocol-scoped | AMEND | D3 → D3 (Anthropic path); D0 (Codex path) | "Transparent" contradicts SAF-004/005 and documented harness capability-degradation; must be wire-level, with enumerated exceptions; Codex CLI is Responses-API only and unevidenced  <!-- taxonomy-sync:claude-adapter:ADRL-FND-001 --> [2026-09-09 offline Claude candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); no maturity change |
...
| ADRL-FND-003 | Routing boundary is the user turn | AMEND | D3 → D3 | Principle vindicated by cache evidence; "user turn" undefined mechanically; pre-warm request misfiles as a turn; gating must be per request; boundary must be per agent lineage  <!-- taxonomy-sync:claude-adapter:ADRL-FND-003 --> [2026-09-09 offline Claude candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); no maturity change |
...
| ADRL-FND-005 | Scope expands only through measured gates | APPROVE | D3 → D3 (governance note) | Sound and currently honoured; gaps (self-graded, no pre-registration, no de-promotion) belong to EVL follow-ups  2026-09-09 <!-- taxonomy-sync:taxonomy-sync-gate:ADRL-FND-005 --> [Scoped sync gate](../../reports/reviews/taxonomy-sync-gate-2026-09-09/report.md); maturity unchanged  <!-- taxonomy-sync:claude-adapter:ADRL-FND-005 --> [2026-09-09 offline Claude candidate](../../reports/reviews/claude-adapter-2026-09-09/report.md); no maturity change  2026-09-10 <!-- taxonomy-sync:review-governance:ADRL-FND-005 --> [Review-ledger governance](../../reports/review-governance-2026-09-10.md); no grade change |
